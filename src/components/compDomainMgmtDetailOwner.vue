    ...
    Col.col2(span="18")
      Form(:label-width="200")
        ...
        FormItem(label="电子邮件：", required)
          comp-input(name='userEmail',label="电子邮件",ref="userEmail",styles="width:300px",:maxLength="64", :defaultValue="detailData.regUserInfo?detailData.regUserInfo.userEmail:''",)
