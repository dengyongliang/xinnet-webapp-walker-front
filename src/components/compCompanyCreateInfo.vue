<template lang="pug">
  Form.compCompanyCreateInfo(:label-width="90")
    ...
    FormItem(label="手机：",required)
      comp-input(name='userMobile',label="手机",ref="userMobile",validate="mobile",styles="width:300px")
    FormItem(label="邮件：",required)
      comp-input(name='userEmail',label="邮件",ref="userEmail",validate="email",styles="width:300px")
    FormItem(label="固话：")
