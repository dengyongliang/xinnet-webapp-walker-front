...
div.step1
  ...
  Form(:label-width="180")
    ...
    FormItem(label="域名持有者名称（中文）：", required)
      comp-input(name='organizeNameCn',label="域名持有者名称",ref="organizeNameCn",:maxLength="100",styles="width:300px", :defaultValue="(type!=='create'?templateData.organizeNameCn:'')", :disabled="type==='modify' || disabled", validate="hasChinese")
    FormItem(label="域名联系人（中文）：", required)
      comp-input(name='userNameCn',label="域名联系人",ref="userNameCn",styles="width:300px", :maxLength="100", :defaultValue="(type!=='create'?templateData.userNameCn:'')", :disabled="disabled", validate="hasChinese")
    ...
    FormItem(label="通讯地址（中文）：", required)
      comp-input(name='streetCn',label="通讯地址",ref="streetCn",styles="width:300px",:maxLength="100", :defaultValue="(type!=='create'?templateData.publicStreetCn:'')", :disabled="disabled", validate="hasChinese")
    ...
    FormItem(label="域名持有者名称（英文）：", required)
      comp-input(name='organizeNameUk',label="域名持有者名称",ref="organizeNameUk",styles="width:300px", :defaultValue="(type!=='create'?templateData.organizeNameUk:'')", :disabled="type==='modify' || disabled", validate="hasEn")
    FormItem(label="域名联系人（英文）：", required)
      comp-input(name='userNameUk',label="英文名",ref="userNameUk",styles="width:300px", placeholder="英文名", :defaultValue="(type!=='create'?templateData.userNameUk:'')", :disabled="disabled", validate="hasEn")
    FormItem(label="")
      comp-input(name='userSureNameUk',label="英文姓",ref="userSureNameUk",styles="width:300px", placeholder="英文姓", :defaultValue="(type!=='create'?templateData.userSureNameUk:'')", :disabled="disabled", validate="hasEn")
    FormItem(label="通讯地址：", required)
      comp-input(name='streetUk',label="通讯地址",ref="streetUk",styles="width:300px", :defaultValue="(type!=='create'?templateData.publicStreetUk:'')", :disabled="disabled", validate="hasEn")
