...
export default {
  ...
  actions: {
    [types.FINANCE_PAY_STATISTICS] ({ commit, rootState }, params) {
      rest.post(links.FINANCE_PAY_STATISTICS, params.param, params.callback)
    },
    [types.FINANCE_PAY_STATISTICS_TREND] ({ commit, rootState }, params) {
      rest.post(links.FINANCE_PAY_STATISTICS_TREND, params.param, params.callback)
    },
    [types.QUERY_FINANCE_CUSTOMER_FLOW_LIST] ({ commit, rootState }, params) {
      rest.post(links.QUERY_FINANCE_CUSTOMER_FLOW_LIST, params.param, params.callback)
    },
    ...
    [types.PAY_STATISTICS_HISTORY_BILL] ({ commit, rootState }, params) {
      rest.post(links.PAY_STATISTICS_HISTORY_BILL, params.param, params.callback)
    }
  }
}
